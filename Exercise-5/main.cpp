...
void debugCorrespondenceMatching() {
	...
	const std::string filenameSource = std::string("D:/tum/tum_02/IN2354/Data/bunny_part2_trans.off");
	const std::string filenameTarget = std::string("D:/tum/tum_02/IN2354/Data/bunny_part1.off");
...
int reconstructRoom() {
	std::string filenameIn = std::string("D:/tum/tum_02/IN2354/Data/rgbd_dataset_freiburg1_xyz/");
