...
int alignBunnyWithProcrustes() {
	...
	const std::string filenameSource = std::string("D:/tum/tum_02/IN2354/Data/bunny_trans.off");
	const std::string filenameTarget = std::string("D:/tum/tum_02/IN2354/Data/bunny.off");
