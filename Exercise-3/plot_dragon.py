...
def main(args):
    ...
    plt.savefig("dragon_fit.png", bbox_inches="tight", dpi= 300)
    plt.close()


if __name__ == "__main__":
    parser = argparse.ArgumentParser()
    parser.add_argument("--data_path", type=str, default="/config/workspace/Data", help="Directory of the data files.")
    parser.add_argument("--deg", type=float, default=42.1614, help="Rotation value in degree from Ceres.")
    parser.add_argument("--tx", type=float, default=1247.02, help="x translation value from Ceres.")
    parser.add_argument("--ty", type=float, default=509.108, help="y translation value from Ceres.")
