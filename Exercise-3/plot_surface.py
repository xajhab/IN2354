...
def visualize(x, y, z, a, b, c):
    ...
    plt.savefig("surface_fit.png", bbox_inches="tight", dpi= 300)
    plt.close()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--a", type=float, default=0.509167, help="The a value from Ceres.")
    parser.add_argument("--b", type=float, default=0.746778, help="The b value from Ceres.")
    parser.add_argument("--c", type=float, default=0.329951, help="The c value from Ceres.")
