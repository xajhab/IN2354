...
def visualize(points_x, points_y, mu, sigma):
    ...
    plt.savefig("gaussian_fit.png", bbox_inches="tight", dpi= 300)
    plt.close()
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mu", type=float, default=1.57729, help="The mu value from Ceres.")
    parser.add_argument("--sigma", type=float, default=0.605089, help="The sigma value from Ceres.")
